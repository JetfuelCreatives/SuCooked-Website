...
const App: React.FC = () => {
      ...
      case 'home':
        return (
          <div className="animate-fade-in">
            ...
            <section className="py-24 bg-white px-4 border-b border-dark/5">
              <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-12 text-center">
                  {[
                    { icon: <MousePointer2 size={48} />, title: '1. Choose', desc: 'Select from our rotating weekly menu of chef-curated dishes.' },
                    { icon: <Package size={48} />, title: '2. We Cook & Deliver', desc: 'Our chefs prep fresh meals and deliver them chilled to your door.' },
                    { icon: <UtensilsCrossed size={48} />, title: '3. Heat & Enjoy', desc: 'Ready in minutes. Plating instructions included for the full experience.' }
                  ].map((step, idx) => (
                    <div key={idx} className="group p-8 border border-transparent hover:border-accent/10 hover:bg-cream transition-all duration-300 rounded-lg">
                      <div className="flex justify-center mb-6 text-accent transform group-hover:scale-110 transition-transform">
                        {step.icon}
                      </div>
              ...
              <div className="flex flex-col md:flex-row w-full h-full">
                <div className="w-full md:w-1/2 flex flex-col justify-center px-8 py-20 lg:px-24 bg-white">
                  ...
                  <h2 className="text-5xl lg:text-7xl font-serif leading-tight mb-8 max-w-lg">
                    Catering for <br />
                    <span className="italic font-normal">Every Occasion</span>
                  </h2>
                  <p className="text-gray-500 text-lg mb-12 max-w-md leading-relaxed">
                    From intimate gatherings to corporate events, our catering team delivers exceptional cuisine tailored to your needs.
                  </p>
                  <button 
                    onClick={() => setView('catering')}
                    className="w-fit flex items-center gap-3 border border-dark px-10 py-4 text-xs font-bold uppercase tracking-[0.2em] hover:bg-dark hover:text-white transition-all duration-300"
                  >
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-cream text-dark">
      <Header 
